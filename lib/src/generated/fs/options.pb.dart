...
class MethodOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MethodOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'fs'), createEmptyInstance: create)
    ..e<MethodOptions_Mode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode', $pb.PbFieldType.OE, defaultOrMaker: MethodOptions_Mode.Both, valueOf: MethodOptions_Mode.valueOf, enumValues: MethodOptions_Mode.values)
    ..e<MethodOptions_CacheMode>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cacheMode', $pb.PbFieldType.OE, protoName: 'cacheMode', defaultOrMaker: MethodOptions_CacheMode.NoCache, valueOf: MethodOptions_CacheMode.valueOf, enumValues: MethodOptions_CacheMode.values)
  ...
  @$pb.TagNumber(1)
  set mode(MethodOptions_Mode v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set cacheMode(MethodOptions_CacheMode v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class FieldExts extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FieldExts', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'fs'), createEmptyInstance: create)
    ...
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validation')
    ..hasRequiredFields = false
  ;
  ...
  factory FieldExts.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FieldExts.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FieldExts copyWith(void Function(FieldExts) updates) => super.copyWith((message) => updates(message as FieldExts)) as FieldExts; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static FieldExts getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FieldExts>(create);
  ...
  @$pb.TagNumber(7)
  set validation($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
...
class Options {
  static final options = $pb.Extension<MethodOptions>(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf.MethodOptions', const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'options', 1001, $pb.PbFieldType.OM, defaultOrMaker: MethodOptions.getDefault, subBuilder: MethodOptions.create);
  static final exts = $pb.Extension<FieldExts>(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf.FieldOptions', const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exts', 1001, $pb.PbFieldType.OM, defaultOrMaker: FieldExts.getDefault, subBuilder: FieldExts.create);
