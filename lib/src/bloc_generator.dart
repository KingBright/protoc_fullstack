...
class BlocGenerator extends ProtobufContainer {
  ...
  final List<BlocGenerator> _isarGenerators = <BlocGenerator>[];
  ...
  BlocGenerator._(
    ...
    for (var i = 0; i < _descriptor.nestedType.length; i++) {
      ...
      _isarGenerators.add(BlocGenerator.nested(
